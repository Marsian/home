...
TOEM 的核心不是大地图，而是观察、拍照、解决小问题。它对 `star-trip` 的启发是：世界中的“发现”可以来自视角和注意力，不一定来自复杂系统。球面星球很适合加入“从某个角度看到星座连线 / 遗迹轮廓”的轻谜题。
...
- 世界目标：一个半径有限但垂直和环绕路线充足的球面星球，尺度要能容纳大量角色与地形，山顶通讯塔始终作为清晰远景目标。
